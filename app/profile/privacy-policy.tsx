...
export default function PrivacyPolicyScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    updated: { color: colors.textSecondary, marginBottom: 16 },
    sectionTitle: {
      fontSize: 16,
      fontWeight: "600",
      marginTop: 16,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.paragraph}>
          ...
          collect, how we use it, and your choices. By using this app, you agree
        ...
        <Text style={styles.paragraph}>
          ...
          booking orders, processing payments, customer support, and
          personalizing your experience. We may also use data for security,
          fraud prevention, and to comply with legal obligations.
        </Text>

        <Text style={styles.sectionTitle}>3. Sharing of Information</Text>
        <Text style={styles.paragraph}>
          We do not sell your personal information. We may share data with
          trusted service providers who assist in operating the app (e.g.,
          payment processing, cloud storage), and when required by law.
        </Text>
        ...
        <Text style={styles.paragraph}>
          You can update your profile information in the app. You may disable
          location access from your device settings. For data access or deletion
        ...
        <Text style={styles.paragraph}>
          ...
          via the Help & Support page in the app.
        </Text>
